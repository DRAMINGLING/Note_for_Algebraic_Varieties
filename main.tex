...
\begin{proof}
    ...
    \begin{equation}
        \begin{pmatrix}
            \frac{\partial G_{1}}{\partial y_{1/0}} & \cdots & \frac{\partial G_{1}}{\partial y_{n/0}} \\
            \vdots & \ddots & \vdots \\
            \frac{\partial G_{n - \dim X}}{\partial y_{1/0}} & \cdots & \frac{\partial G_{n - \dim X}}{\partial y_{n/0}} \\
            \frac{\partial F}{\partial y_{1/0}} & \cdots & \frac{\partial F}{\partial y_{n/0}}
        \end{pmatrix}
    \end{equation}
