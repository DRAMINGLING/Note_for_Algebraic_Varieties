...
\begin{proof}
    ...
    \par
    Note that $\delta_{\mathbb{P}_{k}^{2}} \subseteq \mathbb{P}_{k}^{2} \times \mathbb{P}_{k}^{2}$ is defined by $\{x_{0}y_{1} = x_{1}y_{0}, x_{0}y_{2} = x_{2}y_{0}, x_{1}y_{2} = x_{2}y_{1}\}$, which is an irreducible subvariety of codimension $1$,
    we get that $\delta_{X}$ is defined
\end{proof}
